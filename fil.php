    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" id="content">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'GET') {
                    ...
                    $query = "SELECT name, et0, last_update as Date
                    FROM et0
                    WHERE (name, last_update) IN (
                        SELECT name, MAX(last_update) AS MaxDate
                        FROM courant
                         GROUP BY et0
     ...
     <script>
        function exportData() {
            ...
            XLSX.writeFile(workbook, 'Et0.xlsx');
        }
    </script>
